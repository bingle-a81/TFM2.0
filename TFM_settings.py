    ...
    match machine:
        ...
        case "Citizen Cincom L12(1)":
            return (
                ...
                "citizen_folder1.png",
                "citizen_folder11.png",
            )
        case "Citizen Cincom L12(2)":
            return (
                "citizen_machine2.png",
                "citizen_folder2.png",
                "citizen_folder22.png",
            )
        case "_":
...
class Get_config:
    ...
    def get_yaml_file(self, file_name):
        return os.path.realpath(
            config.get_set_default("source")
            + config.get_set_default("DIR_TEMP")
            + config.get_set_default(file_name)
        )
